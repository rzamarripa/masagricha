<?php
	...
	if(!isset($presFormateado["Presupuesto"])){
		$presFormateado["Presupuesto"][] = array();
	}
	if(!isset($presFormateado["Actual"])){
		$presFormateado["Actual"][] = array();
	}
...
<script type="text/javascript">
	$(function () {
		$('#costos').show();
		$("#presupuesto_semana").attr('selectedIndex', 0);
    $('#grafica').highcharts({
        title: {
